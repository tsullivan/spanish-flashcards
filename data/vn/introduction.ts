...
export const Introduction: CardCollection = {
  ...
  'Vowel Combinations': [{ cards: [
    ...
    { question: 'ai', answer: 'as in "Thailand" or "eye"', phrases: [
      { answer: 'two', question: 'hai' },
      { answer: 'who', question: 'ai' },
      { answer: 'ear', question: 'tai' },
    ] },
    // ao - as in "town" or "cow"
    { question: 'ao', answer: 'as in "town" or "cow"', phrases: [
    ...
    { question: 'au', answer: 'a combination of "ah" as in "hot" and "oo" as in "food"', phrases: [
    ...
    { question: 'ay', answer: 'a combination of "ah" as in "hot" and "ee" as in "need"', phrases: [
    ...
    { question: 'âu', answer: 'a combination of "o" as in "oh" and "oo" as in "food"', phrases: [
      { answer: 'sentence', question: 'câu' },
      { answer: 'where', question: 'đâu' },
      { answer: 'deep', question: 'sâu' },
    ] },
    // ây - as in "may"
    { question: 'ây', answer: 'as in "may"', phrases: [
    ...
    { question: 'eo', answer: 'a combination of "e" as in "bed" and "oo" as in "food"', phrases: [
    ...
    { question: 'ôi', answer: 'a combination of "o" as in "oh" and "ee" as in "need"', phrases: [
    ...
    { question: 'ơi', answer: 'a combination of "a" as in "sofa" and "ee" as in "need"', phrases: [
    ...
    { question: 'ua/uâ', answer: '"wa" as in "qualm" when preceded by "q"; elsewhere a combination of "oo" as in "food" and "a" as in "sofa"', phrases: [
      { answer: 'to buy', question: 'mua' },
      { answer: 'to dance', question: 'múa' },
      { answer: 'spring (season)', question: 'xuân' },
    ] },
    // uê - as in "sway"
    { question: 'uê', answer: 'as in "sway"', phrases: [
      { answer: 'to rent, to hire', question: 'thuê' },
      { answer: 'hometown, countryside', question: 'quê' },
      { answer: 'Hue (city)', question: 'Huế' },
    ] },
    // ui - as in "gooey"
    { question: 'ui', answer: 'as in "gooey"', phrases: [
    ...
    { question: 'uô', answer: 'a combination of "oo" as in "food" and "o" as in "oh"', phrases: [
      { answer: 'to want', question: 'muốn' },
      { answer: 'sad', question: 'buồn' },
      { answer: 'bell', question: 'chuông' },
    ] },
    // uơ - as in "twirl"
    { question: 'uơ', answer: 'as in "twirl"', phrases: [
      { answer: 'period, era', question: 'thuở' },
      { answer: 'to wave, to swing', question: 'huơ' },
    ] },
    // uy - as in "tweet"
    { question: 'uy', answer: 'as in "tweet"', phrases: [
    ...
    { question: 'ưa', answer: 'a combination of "uh" as in "huh" and "a" as in "sofa"', phrases: [
    ...
    { question: 'ưi', answer: 'a combination of "uh" as in "huh" and "ee" as in "need"', phrases: [
      { answer: 'to send', question: 'gửi' },
      { answer: 'to smell', question: 'ngửi' },
    ] },
    // ươ - a combination of "uh" as in "huh" and "a" as in "sofa"
    { question: 'ươ', answer: 'a combination of "uh" as in "huh" and "a" as in "sofa"', phrases: [
    ...
    { question: 'uôi', answer: 'a combination of "oo" as in "food" and "ee" as in "need"', phrases: [
    ...
    { question: 'uya', answer: 'a combination of "wee" as in "tweet" and "a" as in "sofa"', phrases: [
      { answer: 'late at night', question: 'khuya' },
    ] },
    // uyê - a combination of "wee" as in "tweet" and "ay" as in "may"
    { question: 'uyê', answer: 'a combination of "wee" as in "tweet" and "ay" as in "may"', phrases: [
    ...
    { question: 'ươi', answer: 'a combination of "uh" as in "huh", "a" as in "sofa", and "ee" as in "need"', phrases: [
