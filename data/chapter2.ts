...
export const Chapter2: CardCollection = {
  ...
  'Introducing Regular Verbs, Present Tense': [
      ...
      cards: [
        {
          ...
          question: 'hablar',
          phrases: [
            { answer: 'I speak', question: 'yo hablo' },
        ...
        },
        {
          ...
          question: 'preparar',
          phrases: [
            { answer: 'I prepare', question: 'yo preparo' },
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          question: 'entender', // comprender?
          phrases: [
            { answer: 'I understand', question: 'yo entiendo' },
    ...
    },
    {
      ...
      cards: [
        ...
        { answer: 'the paella', question: 'la paella', phrases: [{ answer: 'I made a paella', question: 'Hice una paella' }] },
        { answer: 'the restaurant', question: 'el restaurante', phrases: [{ answer: 'The restaurant is good', question: 'El restaurante es bueno' }] },
        { answer: 'the menu', question: 'el menú', phrases: [{ answer: 'The menu is interesting', question: 'El menú es interesante' }] },
        { answer: 'the bill', question: 'la cuenta', phrases: [{ answer: 'The bill, please', question: 'La cuenta, por favor' }] },
        { answer: 'the tip', question: 'la propina', phrases: [{ answer: 'The tip is included', question: 'La propina está incluida' }] },
        { answer: 'the dessert', question: 'el postre', phrases: [{ answer: 'The dessert is delicious', question: 'El postre está delicioso' }] },
        { answer: 'the appetizer', question: 'el aperitivo', phrases: [{ answer: 'The appetizer is tasty', question: 'El aperitivo está sabroso' }] },
        { answer: 'the soup', question: 'la sopa', phrases: [{ answer: 'The soup is hot', question: 'La sopa está caliente' }] },
        { answer: 'the salad', question: 'la ensalada', phrases: [{ answer: 'The salad is fresh', question: 'La ensalada está fresca' }] },
        { answer: 'the bread', question: 'el pan', phrases: [{ answer: 'The bread is soft', question: 'El pan está suave' }] },
        { answer: 'the cheese', question: 'el queso', phrases: [{ answer: 'The cheese is delicious', question: 'El queso está delicioso' }] },
        { answer: 'the wine', question: 'el vino', phrases: [{ answer: 'The wine is good', question: 'El vino es bueno' }] },
        { answer: 'the water', question: 'el agua', phrases: [{ answer: 'The water is cold', question: 'El agua está fría' }] },
        { answer: 'the coffee', question: 'el café', phrases: [{ answer: 'The coffee is hot', question: 'El café está caliente' }] },
      ],
    },
  ],
  'Introducing Irregular Verbs, Present Tense': [
    {
      cards: [
        ...
        },
        {
          ...
          question: 'querer',
          phrases: [
            { answer: 'I want', question: 'yo quiero' },
    ...
    },
    {
      ...
      cards: [
        ...
        { answer: 'the family', question: 'la familia', phrases: [{ answer: 'My family is big', question: 'Mi familia es grande' }] },
        { answer: 'the mother', question: 'la madre', phrases: [{ answer: 'My mother is kind', question: 'Mi madre es amable' }] },
        { answer: 'the father', question: 'el padre', phrases: [{ answer: 'My father is strong', question: 'Mi padre es fuerte' }] },
        { answer: 'the brother', question: 'el hermano', phrases: [{ answer: 'My brother is funny', question: 'Mi hermano es divertido' }] },
        { answer: 'the sister', question: 'la hermana', phrases: [{ answer: 'My sister is smart', question: 'Mi hermana es inteligente' }] },
      ],
    },
    {
